...
def run():
    ...
    for code_length in args.code_length:
        ...
        logger.info('[code_length:{}][map:{:.4f}]'.format(code_length, mACC))
...
def load_config():
    ...
    parser.add_argument('--dataset',
                        help='Dataset name.', default='brainData')
    parser.add_argument('--root',
                        help='Path of dataset', default='D:/algorithm/ADSH_PyTorch/data')
    parser.add_argument('--batch-size', default=64, type=int,
                        help='Batch size.(default: 64)')
    parser.add_argument('--lr', default=1e-3, type=float,
                        help='Learning rate.(default: 1e-4)')
    parser.add_argument('--code-length', default='8,24,32,48', type=str,
